...
$("document").ready(function () {
    ...
    var wine = new Bloodhound({
        ...
        remote: {
            url: 'https://cors-anywhere.herokuapp.com/http://api.snooth.com/wines/?q=%QUERY&akey=5pgy0fabib7s89ky9l5fx24ha754svspwnata652tn7gdr71&s=sr',
    ...
    $("#search").keypress(function (e) {
        ...
        var queryURL = "https://cors-anywhere.herokuapp.com/http://api.snooth.com/wines/?q=" + search + "&akey=5pgy0fabib7s89ky9l5fx24ha754svspwnata652tn7gdr71&n=25";
        ...
        if (e.which === 13 && $("#search").val().trim() != "") {
            ...
            $.ajax({
                ...
                for (m = 0; m < wineCodeArray.length; m++) {
                    var pairingURL = "https://cors-anywhere.herokuapp.com/http://api.snooth.com/wine/?food=1&id=" + wineCodeArray[m] + "&akey=5pgy0fabib7s89ky9l5fx24ha754svspwnata652tn7gdr71";
                    $.ajax({
                        url: pairingURL,
                        method: "GET"
